...
const RenderFicheBilanSUAP = ({ data }) => {
  ...
  return (
    <Box width="80%" margin="auto" border="1px" borderColor="gray.300" borderRadius="md" p={5} boxShadow="md" mb={10}>
      ...
      <Button onClick={toggleExpand} colorScheme="blue" mt={4}>
        {isExpanded ? 'Réduire la fiche' : 'Dérouler la fiche'}
      </Button>
      <Button onClick={handleDownloadPDF} colorScheme="blue" mt={4} ml={4}>
        Aller au téléchargement en PDF 
      </Button>
