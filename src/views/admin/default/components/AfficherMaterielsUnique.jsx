...
const AfficherMaterielsUnique = ({ selectedTeamId }) => {
    ...
    const handleAssociation = async () => {
        ...
        if (error) {
            ...
            // Mettre à jour la liste des matériels après l'association
            setMateriels(materiels.map(materiel =>
                materiel.id === selectedMaterial.id
                    ? { ...materiel, associated_team_id: selectedTeam.id, associated_team_name: selectedTeam.name_of_the_team }
                    : materiel
            ));
        }
    };
    ...
    const filteredMateriels = materiels.filter((materiel) => {
        if (selectedTeamId) {
            return materiel.associated_team_id === selectedTeamId;
        }
        return true;
    });
...
export default AfficherMaterielsUnique;
