...
const InformationsFileUploadForm = () => {
  ...
  const handleUpload = async () => {
    ...
    let { error: uploadError } = await supabase.storage
      .from('vianney-informations-fichiers') // Remplacez par le nom du bucket correct
    ...
    const { error: dbError } = await supabase
      .from('vianney_informations_fichiers') // Remplacez par la table correcte
...
export default InformationsFileUploadForm;
